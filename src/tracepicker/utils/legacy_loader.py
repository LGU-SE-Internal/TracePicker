...
from ..entities.trace import Trace as NewTrace, Span as NewSpan
...
def load_legacy_pickle(file_path: str) -> Any:
    ...
    try:
        ...
        if isinstance(data, list):
            ...
            logger.info(f"Successfully converted {len(converted_data)} traces from legacy format")
